...
//			s.setContentType("application/json");
	...
	public static String request(Map<String, Object> map,String token,String service,String method){
		...
		if(paramValue.substring(paramValue.length() - 1, paramValue.length()).equals(",")){
			paramValue = paramValue.substring(0, paramValue.length() - 1);
		}
		paramValue = paramValue + "]";
		System.out.println("param :" + paramValue);
		long wsstart = System.currentTimeMillis();
		String result = doPostAndHeader(Constants.URL, paramValue,token,service,method);
		long wsend = System.currentTimeMillis();
		System.out.println("用时：" + (wsend - wsstart));
		System.out.println(result);
		return result;
	}
	public static String request2(Map<String, Object> map,String token,String service,String method){
		StringBuilder param = new StringBuilder("[");
		String json = JSONObject.toJSONString(map);
		param.append(json).append("]");
		System.out.println("param :" + json);
		long wsstart = System.currentTimeMillis();
		String result = doPostAndHeader(Constants.URL, param.toString(),token,service,method);
		long wsend = System.currentTimeMillis();
		System.out.println("用时：" + (wsend - wsstart));
		System.out.println(result);
		return result;
...
//    	map.put("keyValue", "\"盐酸\"");
    	...
    	map.put("type", 0);
    	request2(map,"607c9c61-d1b3-4ee6-85f9-64d267d32842","ckb.medicationRpcServer","queryMedicationTree");
